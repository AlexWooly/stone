    ...
    public KeyGenerator springCacheCustomKeyGenerator(){
        return new KeyGenerator() {
            ...
            public Object generate(Object o, Method method, Object... objects) {
                System.out.println(o.getClass().getSimpleName()+"_"+method.getName()+"_"+ StringUtils.arrayToDelimitedString(objects,"-"));
                return o.getClass().getSimpleName()+"_"+method.getName()+"_"+ StringUtils.arrayToDelimitedString(objects,"-");
            }
        };
    }
