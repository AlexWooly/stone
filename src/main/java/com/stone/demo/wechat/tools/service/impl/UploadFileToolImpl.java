package com.stone.demo.wechat.tools.service.impl;

import cn.hutool.core.io.FileUtil;
import cn.hutool.core.util.ObjectUtil;
import com.stone.demo.util.JsonData;
import com.stone.demo.wechat.constant.Constant;
import com.stone.demo.wechat.tools.domain.UploadFile;
import com.stone.demo.wechat.tools.repository.UploadFileRepository;
import com.stone.demo.wechat.tools.service.UploadFileTool;
...
public class UploadFileToolImpl implements UploadFileTool {
    ...
    public JsonData upload(String uploader, String realName, MultipartFile multipartFile) {
        //检查文件大小
        ...
        try {
            ...
            return JsonData.buildSuccess(uploadFileRepository.insert(uploadFile));
